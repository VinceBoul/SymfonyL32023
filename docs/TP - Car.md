...
* Voiture (Car)
  * nom (chaîne de caractères)
	...
	* marque (Liste déroulante avec les choix : "Renault", "Peugeot", "Audi", "BMW")

* Dans le **formulaire** : Modifier le label du champ "marque" par "Marque de la voiture"
* Dans la **liste** : 
  * Ajouter un lien pour augmenter le prix de 1000€
  * Mettre en place un filtre "prix maximum" de la liste sur la propriété prix

* Mettre en place une contrainte (Assert) sur la propriété "prix" pour que le prix ne puisse pas être supérieur à 200 000 €
